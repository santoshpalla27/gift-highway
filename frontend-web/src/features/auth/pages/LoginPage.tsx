            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
              ...
              <div style={{ position: 'relative' }}>
                <input
                  ...
                  placeholder="••••••••"
                  {...register('password')}
                  style={{ width: '100%', padding: '10px 40px 10px 12px', background: 'var(--surface-2)', border: `1.5px solid ${errors.password ? 'var(--danger)' : 'var(--border)'}`, borderRadius: 'var(--radius)', fontSize: '13px', color: 'var(--text-primary)', outline: 'none', transition: 'all var(--t-fast)', boxSizing: 'border-box' }}
                ...
                <button
                  ...
                  style={{ position: 'absolute', right: 10, top: '50%', transform: 'translateY(-50%)', background: 'none', border: 'none', cursor: 'pointer', padding: 4, display: 'flex', alignItems: 'center', color: 'var(--text-tertiary)' }}
                >
                  {showPassword ? (
